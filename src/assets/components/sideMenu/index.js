    ...
    return (
      <Container style={{ BackgroundColor: 'white' }}>
        <SafeAreaView backgroundColor={colors.primary} />
          ...
          <AppList iconName="user" title="Sales Cover Letter" />
          <AppList iconName="microscope" title="Science Cover Letter" />
          <AppList iconName="user-graduate" title="Student Cover Letter" />
